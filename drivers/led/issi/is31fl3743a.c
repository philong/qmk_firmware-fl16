...
#ifndef IS31FL3743A_PHASE_DELAY_1
#    define IS31FL3743A_PHASE_DELAY_1 IS31FL3743A_PHASE_DELAY_DISABLE
#endif
#ifndef IS31FL3743A_PHASE_DELAY_2
#    define IS31FL3743A_PHASE_DELAY_2 IS31FL3743A_PHASE_DELAY_DISABLE
#endif
#ifndef IS31FL3743A_PHASE_DELAY_3
#    define IS31FL3743A_PHASE_DELAY_3 IS31FL3743A_PHASE_DELAY_DISABLE
#endif
#ifndef IS31FL3743A_PHASE_DELAY_4
#    define IS31FL3743A_PHASE_DELAY_4 IS31FL3743A_PHASE_DELAY_DISABLE
#endif

#ifndef IS31FL3743A_SPREAD_SPECTRUM
#    define IS31FL3743A_SPREAD_SPECTRUM IS31FL3743A_SSP_DISABLE
#endif
#ifndef IS31FL3743A_SPREAD_SPECTRUM_RANGE
#    define IS31FL3743A_SPREAD_SPECTRUM_RANGE IS31FL3743A_RNG_5_PERCENT
#endif
#ifndef IS31FL3743A_SPREAD_SPECTRUM_CYCLE_TIME
#    define IS31FL3743A_SPREAD_SPECTRUM_CYCLE_TIME IS31FL3743A_CLT_1980_US
#endif
...
const uint8_t driver_phase_delay[IS31FL3743A_DRIVER_COUNT] = {
    IS31FL3743A_PHASE_DELAY_1,
#ifdef IS31FL3743A_I2C_ADDRESS_2
    IS31FL3743A_PHASE_DELAY_2,
#    ifdef IS31FL3743A_I2C_ADDRESS_3
    IS31FL3743A_PHASE_DELAY_3,
#        ifdef IS31FL3743A_I2C_ADDRESS_4
    IS31FL3743A_PHASE_DELAY_4,
#        endif
#    endif
#endif
};
...
void is31fl3743a_init(uint8_t index) {
    ...
    is31fl3743a_write_register(index, IS31FL3743A_FUNCTION_REG_PULLDOWNUP, (driver_phase_delay[index] << 7) | (IS31FL3743A_SW_PULLDOWN << 4) | IS31FL3743A_CS_PULLUP);
    is31fl3743a_write_register(index, IS31FL3743A_FUNCTION_REG_GLOBAL_CURRENT, IS31FL3743A_GLOBAL_CURRENT);
    is31fl3743a_write_register(index, IS31FL3743A_FUNCTION_REG_SPREAD_SPECTRUM, ((sync & 0b11) << 6) | (IS31FL3743A_SPREAD_SPECTRUM << 4) | (IS31FL3743A_SPREAD_SPECTRUM_RANGE << 2) | IS31FL3743A_SPREAD_SPECTRUM_CYCLE_TIME);
